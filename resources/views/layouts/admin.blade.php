            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <li>
                    <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i
                                class="fa fa-fw fa-arrows-v"></i> Categories <i class="fa fa-fw fa-caret-down"></i></a>
                    <ul id="demo" class="collapse">
                        <li>
                            <a href="{{ route('createCategory') }}">New Category </a>
                        </li>
                        <li>
                            <a href="{{route('allCategory')}}">All Categories </a>
                        </li>
                        <li>
                            <a href="{{route('allTrashedCategories')}}">Trashed Categories </a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="{{route('createArticle')}}"><i class="fa fa-fw fa-edit"></i> New Article</a>
                </li>
                <li>
                    <a href="{{route('allArticles')}}"><i class="fa fa-fw fa-edit"></i> All Articles</a>
                </li>
                <li>
                    <a href="{{route('allTrashedArticles')}}"><i class="fa fa-fw fa-edit"></i> Deleted Articles</a>
                </li>
                <li>
