            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">
                        List Of All Trashed Categories
                    </h1>
                    <ol class="breadcrumb">
                        <li>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('restoreTrashedCategory', $category->id)}}" class="btn btn-primary" role="button">Восстановить</a>
                                <a href="{{route('forceDeleteCategory', $category->id)}}" class="btn btn-danger" role="button">Удалить</a>
                    ...
                    <div>
                        <ul class="pagination">
                            ...
                            <li><a href="{{route('allTrashedCategories')}}?page={{$i}}">{{$i}}</a></li>
                            @endfor
